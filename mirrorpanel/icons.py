...
def _setup_draw(size: int):
    """Prepara a imagem e o objeto Draw - repetido no inicio de todo icone."""
    img = _canvas(size)
...
if __name__ == "__main__":
    save_app_ico(Path(__file__).resolve().parent.parent / "installer" / "mirrorpanel.ico")
    print("icone gerado")
